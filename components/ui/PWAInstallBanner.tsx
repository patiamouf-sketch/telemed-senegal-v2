          ...
          <div className="p-4 rounded-[24px] bg-[#0B132B]/95 backdrop-blur-2xl border border-blue-500/30 shadow-2xl shadow-blue-950/60 text-white flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              <button
                ...
                className="px-3.5 py-2 rounded-full bg-gradient-to-r from-blue-500 to-sky-400 hover:from-blue-600 hover:to-sky-500 text-white text-xs font-extrabold shadow-md shadow-blue-500/30 transition-all flex items-center gap-1.5 active:scale-95"
              >
        ...
        {showIOSModal && (
          <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-end sm:items-center justify-center p-4">
            <motion.div
              ...
              className="w-full max-w-sm bg-[#0B132B] border border-blue-500/30 rounded-[28px] p-6 text-white shadow-2xl space-y-5"
            >
              ...
              <button
                type="button"
                onClick={() => setShowIOSModal(false)}
                className="w-full py-2.5 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-lg shadow-blue-500/25 transition-colors"
              >
                J'ai compris
              </button>
            </motion.div>
