    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 font-sans">
      ...
      <div className="w-full">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-3 w-full">
          ...
          <a
            href="#salle-attente"
            className="px-3.5 py-2.5 rounded-2xl bg-blue-50/80 hover:bg-blue-100/80 text-blue-800 text-xs font-bold transition-all flex items-center justify-between border border-blue-200/70 shadow-sm active:scale-98 group"
          >
            <div className="flex items-center gap-2 min-w-0">
              <Users className="w-4 h-4 text-blue-600 flex-shrink-0 group-hover:scale-110 transition-transform" />
              <span className="truncate">Salle d'Attente</span>
            </div>
            <span className="px-2 py-0.5 rounded-full bg-blue-600 text-white text-[10px] font-black shadow-sm flex-shrink-0">
              {queue.length}
            </span>
          </a>

          {/* Volet 2 : Suivis 24h & Dossiers */}
          <a
            href="#suivis-dossiers"
            className="px-3.5 py-2.5 rounded-2xl bg-amber-50/80 hover:bg-amber-100/80 text-amber-900 text-xs font-bold transition-all flex items-center justify-between border border-amber-200/70 shadow-sm active:scale-98 group"
          >
            <div className="flex items-center gap-2 min-w-0">
              <Clock className="w-4 h-4 text-amber-600 flex-shrink-0 group-hover:scale-110 transition-transform" />
              <span className="truncate">Suivis & Dossiers</span>
            </div>
            <div className="flex items-center gap-1 flex-shrink-0">
              {followUpCount > 0 && <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />}
              <span className="px-2 py-0.5 rounded-full bg-amber-600 text-white text-[10px] font-black shadow-sm">
                {archive.length}
              </span>
            </div>
          </a>
          ...
          {/* Volet 3 : Ordonnances */}
          <a
            href="#ordonnances-emises"
            className="px-3.5 py-2.5 rounded-2xl bg-emerald-50/80 hover:bg-emerald-100/80 text-emerald-900 text-xs font-bold transition-all flex items-center justify-between border border-emerald-200/70 shadow-sm active:scale-98 group"
          >
            <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="px-2 py-0.5 rounded-full bg-emerald-600 text-white text-[10px] font-black shadow-sm flex-shrink-0">
