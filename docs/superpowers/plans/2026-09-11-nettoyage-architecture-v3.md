...
- [ ] **Étape 1 : Nettoyer `doctorService.ts` de tous les appels à l'API sync**
...
- [ ] **Étape 4 : Supprimer définitivement le dossier `app/api/consultation/sync/`**
Supprimer le fichier `app/api/consultation/sync/route.ts` et son répertoire parent.

- [ ] **Étape 5 : Vérification & Commit**
...
- [ ] **Étape 1 : Rétablir le statut initial à `'pending'` dans `createDoctorProfile`**
...
- [ ] **Étape 2 : Mettre à jour `AuthContext.tsx` pour respecter le statut réel**
...
- [ ] **Étape 3 : Vérifier l'affichage de `PendingApprovalView` dans `app/page.tsx`**
...
- [ ] **Étape 4 : Protéger la page cabinet public `app/dr/[slug]/page.tsx`**
...
- [ ] **Étape 1 : Implémenter le sas de vérification d'accès dans `app/admin-thiam/page.tsx`**
...
- [ ] **Étape 1 : Rédiger `firestore.rules`**
...
- [ ] **Étape 2 : Déclarer `firestore.rules` dans `firebase.json`**
